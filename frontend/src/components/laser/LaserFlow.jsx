...
export default function LaserFlow({
  ...
  useEffect(() => {
    ...
    // ✅ IMPORTANT: ascoltiamo sul CONTAINER, non sul canvas (perché il canvas ha pointer-events:none)
    ...
    mount.addEventListener("pointerdown", onMove, { passive: true });
    mount.addEventListener("pointerenter", onMove, { passive: true });
