    ...
    <>
      {!reordering && (
        <div className="ro-trigger-wrap">
          <button
            ...
            onClick={() => {
              setItems(products.filter(p => p.active ?? true));
              setReordering(true);
            }}
          >
      ...
      {reordering && (
        <p className="ro-help-note">
          Solo i prodotti attivi possono essere riordinati. Col mouse trascina direttamente la card; da tablet o telefono tocca la card da spostare e poi la
          destinazione.
        </p>
      )}
